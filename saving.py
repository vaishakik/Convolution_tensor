...
def optimize(num_iterations):
    ...
    #saver.save(session, 'savedModel/cnn_5class')
...
print("Predicted class for test_Bhajanmantap: {}".format(sample_prediction(test_cat)))
print("Predicted class for test_chariot: {}".format(sample_prediction(test_dog)))
all_vars = tf.global_variables()
saver = tf.train.Saver()
saver.save(session, 'savedModel/cnn_5class')
session.close
